...
const headingVariants = cva("relative mb-1", {
	variants: {
		variant: {
			h1: "mt-[1.6em] pb-1 font-heading font-medium text-4xl",
			h2: "mt-[1.4em] pb-px font-heading font-medium text-2xl tracking-tight",
			h3: "mt-[1em] pb-px font-heading font-medium text-xl tracking-tight",
			h4: "mt-[0.75em] font-heading font-medium text-lg tracking-tight",
			h5: "mt-[0.75em] font-medium text-lg tracking-tight",
			h6: "mt-[0.75em] font-medium text-base tracking-tight",
		},
	},
});
