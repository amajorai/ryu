# <img src="https://raw.githubusercontent.com/amajorai/ryu/main/.github/logo.png" width="50" align="center" alt="" />&nbsp; ryu-sdk-napi
...
One of three bindings over the shared kernel — alongside [`ryu-sdk-ffi`](../ryu-sdk-ffi) (C-ABI / Go) and [`ryu-sdk-uniffi`](../ryu-sdk-uniffi) (Python/Swift/Kotlin) — and the only one that keeps the streaming closure boundary, via napi-rs `ThreadsafeFunction`.
