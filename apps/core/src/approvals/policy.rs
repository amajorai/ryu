...
const RISKY_PATTERNS: &[&str] = &[
    "send", "delete", "remove", "destroy", "drop", "pay", "purchase", "buy",
    "transfer", "wire", "charge", "refund", "publish", "deploy", "release",
    "rotate", "revoke", "grant", "uninstall", "shutdown", "reboot", "kill",
    "email", "sms", "message", "post", "tweet", "merge", "force_push",
];
