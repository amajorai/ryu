...
//!   gate the [`crate::server::realtime_ws`] transport applies to every inbound
//!   frame.
//!
//! ## Wiring
//!
//! [`DocRegistry`] is a field of [`crate::server::ServerState`] and is driven by
...
fn default_db_path() -> PathBuf {
    crate::paths::ryu_dir().join("collab.db")
}
...
impl CollabStore {
    ...
    /// write-access before honoring it (see [`crate::server::realtime_ws`]).
