...
//!
//! This module is the foundation for the Ingest, Catalog, and Export phases.
...
// Foundation module: the public surface is consumed by the Ingest, Catalog, and
// Export phases, which land separately. Until then these items are unreferenced
// from the binary's `main`, so dead-code lints are expected and suppressed here.
#![allow(dead_code)]
