...
**Ghost** is an open-source component of [Ryu](https://ryuhq.com), maintained by
A Major Pte. Ltd.
...
Ghost exposes screen perception and synthetic input control — capabilities with an inherently elevated security and privacy surface.
