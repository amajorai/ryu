...
(`apps/gateway/src/channels/`); a plugin declares the channel as a Runnable in `plugin.json`.
...
## Declaring a channel in plugin.json
...
[plugin.json manifest reference](/docs/develop/extensions/plugin-json-manifest) for the full
