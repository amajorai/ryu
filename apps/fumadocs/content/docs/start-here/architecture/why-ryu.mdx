...
(see [Data and storage](/docs/using-ryu/user-guide/data-and-storage)). This is `BYO everything,
...
```mermaid
flowchart TD
  S["🖥️ Desktop · 💬 Bots · ⚡ Gateway API"] --> G
  G["Ryu Gateway · the moat\nfirewall · PII/DLP · routing · budgets · evals · audit\ndecides WHAT IS ALLOWED, SHARED, MEASURED, PAID FOR"] --> C
  C["Ryu Core · orchestration\nsessions · memory · tools · workflows · sub-agents · sidecars\ndecides WHAT RUNS, then routes every model call to the Gateway"] --> E
