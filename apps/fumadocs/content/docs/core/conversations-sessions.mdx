...
on [Git workspace](/docs/using-ryu/user-guide/git-workspace).
...
blocks or slows the chat write. See [Search and recall](/docs/using-ryu/user-guide/search-and-recall)
