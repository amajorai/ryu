...
| `search_conversations` | Semantic search over the user's past chat messages | Built-in. Backed by the message index; see [Search and recall](/docs/using-ryu/user-guide/search-and-recall) |
