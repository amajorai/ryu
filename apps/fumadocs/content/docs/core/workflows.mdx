...
see [Recipes and the canvas](/docs/using-ryu/productivity/recipes). To author a workflow as a
...
<Callout type="warn">
  ...
  is installed. See [Recipes](/docs/using-ryu/productivity/recipes).
</Callout>
...
<Cards>
  <DocCard href="/docs/using-ryu/productivity/recipes" />
